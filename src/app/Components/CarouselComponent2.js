...
const CarouselComponent2 = ({ className, carouselItems, gifswithsliders }) => {
  ...
  const renderCarouselItems = () => {
    ...
    return gifswithsliders?.map((item, index) => (
      <CarouselItem
      ...
      >
        {/* <Link href={item.link}> */}
          <img className="d-block w-100" 
           style={{ height: isSmallScreen ? "": "27vh"}} 
          src={item.img_url} alt={`Slide `} />
        {/* </Link> */}
