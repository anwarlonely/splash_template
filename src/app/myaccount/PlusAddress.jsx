...
//                             <Image src={plus} width={60} height={60} alt="image" className="mt-4 mb-4" />
//                         </div>
//                         <h1 className={`mt-4 ${style.adddTextStyle1}`} >Add New Billing Address</h1>

//                     </CardBody>
//                 </Card>

//                 <Modal isOpen={modal} fade={false} toggle={toggle} size="lg" style={{ paddingRight: "10px" }}>
//                     <ModalHeader toggle={toggle} style={{ backgroundColor: "rgba(10, 179, 156, 0.10)" }}
//                     >
...
//                                         <Label className="form-label text-dark" htmlFor="first-name-input">
//                                             First Name
//                                         </Label>
//                                         <Input
//                                             type="text"
...
//                                     </div>
//                                     <div className="col-md-6 mb-3">
//                                         <Label className="form-label text-dark" htmlFor="last-name-input">
//                                             Last Name
//                                         </Label>
//                                         <Input
//                                             type="text"
...
//                                             value={validation.values.businessAddress || streetAddress?.structured_formatting?.main_text}
...
//                                 <div className="text-end mb-3 mt-2" style={{ display: "flex", justifyContent: "center" }}>
//                                     <button
//                                         type="submit"
//                                         className="btn w-sm btn-success text-white border border-none"
//                                         onClick={!validation.values.firstName ||
//                                             !validation.values.lastName ||
//                                             !validation.values.businessName ||
//                                             !validation.values.phoneNumber ? handleValidation : toggle}
//                                         style={{ background: "var(--dark-theme-theme-color-green, #3CCF95)" }}
//                                     >
//                                         Add Address
//                                     </button>
//                                 </div>
